            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-12 md:gap-24">
              {[father, mother].map((p) => (
                <div key={p.id} className="flex flex-col items-center group">
                  {/* Circular Image Container with Double Ring */}
                  <div className="relative p-1 rounded-full bg-gradient-to-tr from-amber-200 to-amber-500 mb-6 transition-transform duration-500 group-hover:scale-105">
